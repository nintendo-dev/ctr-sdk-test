...
bool
ProgramObject::Begin(void)
{
	return true;
}

bool
ProgramObject::End(void)
{
	return true;
}

u32
ProgramObject::GetVertexAttributes(void)
{
	return m_VertexAttributes;
}

void
ProgramObject::SetUse3d(const bool use3d)
{
	m_Use3d = use3d;
}

void
ProgramObject::SetProjectionMatrix(const nn::math::MTX44& projectionMatrix)
{
	m_ProjectionMatrix = projectionMatrix;
}

void
ProgramObject::SetModelViewMatrix(const nn::math::MTX44& modelViewMatrix)
{
	m_ModelViewMatrix = modelViewMatrix;
}

void
ProgramObject::SetTextureId(const GLuint textureId)
{
	(void)textureId;
}

void
ProgramObject::Update(void)
{
}

void
ProgramObject::InitializeVertexAttributes(void)
{
	m_VertexAttributes = VERTEX_NONE_ATTRIBUTE;
}

void
ProgramObject::InitializeUniforms(void)
{
	if (m_ProgramId == 0)
	{
...
void
ProgramObject::UpdateModelViewProjectionMatrix(void)
{
	if (m_ProgramId == 0)
	{
		NN_TPANIC_("m_ProgramId is 0.\n");
