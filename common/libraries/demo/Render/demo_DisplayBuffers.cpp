...
, m_DisplayBufferNum(DEMO_DISPLAY_BUFFER_NUM)
...
DisplayBuffersDescription::GetDefaultDisplay0Description(void)
{
	DisplayBuffersDescription displayBuffersDesc;
	displayBuffersDesc.m_TargetDisplay	  = NN_GX_DISPLAY0;
	displayBuffersDesc.m_DisplayBufferNum = DEMO_DISPLAY_BUFFER_NUM;
...
DisplayBuffersDescription
DisplayBuffersDescription::GetDefaultDisplay1Description(void)
{
	DisplayBuffersDescription displayBuffersDesc;
...
DisplayBuffersDescription
DisplayBuffersDescription::GetDefaultDisplay0ExtDescription(void)
{
	DisplayBuffersDescription displayBuffersDesc;
...
void
DisplayBuffers::Initialize(const DisplayBuffersDescription& displayBufferDesc)
{
	if (!m_InitializeFlag)
	{
...
void
DisplayBuffers::Create(const DisplayBuffersDescription& displayBuffersDesc, DisplayBuffers& displayBuffers)
{
	displayBuffers.Initialize(displayBuffersDesc);
}

void
DisplayBuffers::Destroy(DisplayBuffers& displayBuffers)
{
	displayBuffers.Finalize();
}

GLuint
DisplayBuffers::GetTargetDisplayBufferId(void) const
{
	return m_DisplayBufferIdArray[m_CurrentBufferIndex];
}

GLuint
DisplayBuffers::GetPreviousTargetDisplayBufferId(void) const
{
...
GLuint
DisplayBuffers::GetDisplayBufferId(const u32 index) const
{
...
void
DisplayBuffers::IncreaseBufferIndex(void)
{
...
u32
DisplayBuffers::GetWidth(void) const
{
	return m_Width;
}

u32
DisplayBuffers::GetHeight(void) const
{
	return m_Height;
}
