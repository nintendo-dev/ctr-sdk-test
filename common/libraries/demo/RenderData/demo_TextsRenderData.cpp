...
void
TextsRenderData::Initialize(void)
{
}

void
TextsRenderData::Finalize(void)
{
...
void
TextsRenderData::InitializeVertexBuffers(const u32 vertexAttributes, const GLenum triangleType, const u32 maxTextLength)
{
...
void
TextsRenderData::SetMaxTextLength(const u32 maxTextLength)
{
	m_PackedTextLength = 0;
...
void
TextsRenderData::AddText(const f32	 windowCoordinateX,
...
void
TextsRenderData::ClearPackedTextLength(void)
{
	SetPackedTextLength(0);
}

void
TextsRenderData::SetPackedTextLength(const u32 packedTextLength)
{
...
u32
TextsRenderData::GetPackedTextLength(void) const
{
	return m_PackedTextLength;
}

void
TextsRenderData::SetFontSize(const f32 fontSize)
{
	m_FontSize = fontSize;
}

void
TextsRenderData::SetFontColor(const f32 red, const f32 green, const f32 blue, const f32 alpha)
{
	m_Color[0] = red;
	m_Color[1] = green;
	m_Color[2] = blue;
