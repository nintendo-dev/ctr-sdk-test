...
void
PrintGLError(const GLenum errorCode)
{
...
void
InitializeUniforms(const GLuint programId)
{
	...
	s_UniformLocations[FRAGMENT_UNIFORM_FRAGMENT_MATERIAL_SPECULAR0]  = glGetUniformLocation(programId, "dmp_FragmentMaterial.specular0");
	s_UniformLocations[FRAGMENT_UNIFORM_FRAGMENT_MATERIAL_SPECULAR1]  = glGetUniformLocation(programId, "dmp_FragmentMaterial.specular1");
	s_UniformLocations[FRAGMENT_UNIFORM_FRAGMENT_MATERIAL_SAMPLER_D0] = glGetUniformLocation(programId, "dmp_FragmentMaterial.samplerD0");
...
void
GetRandomColor(f32& red, f32& green, f32& blue)
{
