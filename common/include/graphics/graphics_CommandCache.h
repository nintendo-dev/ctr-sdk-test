#ifndef GRAPHICS_COMMAND_CACHE_H_
#define GRAPHICS_COMMAND_CACHE_H_
...
namespace nn { namespace graphics {
	...
	const u32 GRAPHICS_MAX_COMMAND_CACHE_MATRIX_NUM = nn::graphics::detail::VS_UNIFORM_FLOAT_REG_MATRIX_NUM;
