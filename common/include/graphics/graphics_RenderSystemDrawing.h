#ifndef GRAPHICS_RENDER_SYSTEM_DRAWING_H_
#define GRAPHICS_RENDER_SYSTEM_DRAWING_H_

#include "graphics/graphics_GraphicsDrawing.h"
...
namespace nn { namespace graphics {
	...
	*/
	...
	@brief  Indicates the maximum number of triangles that the <tt>GraphicsDrawing</tt> class can hold as rendering data when texture
	mapping.
	*/
	...
	*/
	...
	public:
		...
		*/
		void InitializeTriangles(const u32 maxTrianglesNum = nn::graphics::MAX_TRIANGLES_NUM);
		...
		*/
		void InitializeSquares(const u32 maxSquaresNum = nn::graphics::MAX_SQUARES_NUM);
		...
		<tt>MAX_TEXT_NUM</tt>.)
		*/
		void InitializeTexts(const u32 maxLength = nn::graphics::MAX_TEXT_LENGTH);
	...
	public:
		...
		*/
		...
		@brief  Creates the texture object.
					...
					Whatever is specified with the argument in this method is passed without modification to the <tt>glTexImage2D</tt>
		function.
	...
	public:
		/*!
		@brief  Uses the texture object specified by the handle to texture-map a rectangle specified in window coordinates and render it in
		2D.
		...
		@param[in] windowCoordinateY  Specifies the y-coordinate of the top-left vertex of the rectangle in the window coordinate system
		(<tt>f32</tt> range).
		@param[in] rectangleWidth  Specifies the side in the x-direction of the rectangle in the window coordinate system (<tt>f32</tt>
		range).
		@param[in] rectangleHeight  Specifies the side in the y-direction of the rectangle in the window coordinate system (<tt>f32</tt>
		range).
	...
	*/
	...
	protected:
		...
		GLuint m_TextureIdArray[nn::graphics::MAX_TEXTURES_NUM];

		u32								  m_TotalTexturedTrianglesNumArray[nn::graphics::MAX_TEXTURES_NUM];
		nn::graphics::TrianglesRenderData m_TexturedTrianglesRenderDataArray[nn::graphics::MAX_TEXTURES_NUM];
