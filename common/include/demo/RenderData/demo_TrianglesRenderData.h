...
@brief Specifies the number of vertex color elements (in the format red, green, blue, and alpha, with all elements of type <tt>f32</tt>).
*/
...
@brief Specifies the number of elements for the vertex texture coordinates (all elements of type <tt>f32</tt>, in the format s, t, and r).
*/
...
public:
	...
	*/
	void SetPosition(const u32 index, const GLfloat positionX, const GLfloat positionY, const GLfloat positionZ, const GLfloat positionW);
...
public:
	...
	*/
	...
	@param[in] updateAttributesFlag  Specify <tt>true</tt> if vertex attributes are enabled before rendering, and <tt>false</tt> otherwise.
	*/
