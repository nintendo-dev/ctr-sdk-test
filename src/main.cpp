...
namespace {
nn::graphics::RenderSystemDrawing s_RenderSystem;
...
nnMain()
{
	...
	while (1)
	{
		...
		if (ps.trigger & nn::hid::BUTTON_A || ps.trigger & nn::hid::BUTTON_START)
		{
			if (!(ps.trigger & nn::hid::BUTTON_SELECT_FOR_DEBUGGING))
			{
